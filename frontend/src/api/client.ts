...
export const api = {
  ...
  saveFolgenSynopsen: (folge_id: number | string, data: { folgen_titel?: string | null; synopsis?: string | null; synopsis_300?: string | null; synopsis_kurzinhalt?: string | null; synopsis_presse?: string | null; synopsis_straenge?: string | null; synopsis_pressetext?: string | null; synopsis_lektor?: string | null }) =>
  ...
  getExportWmStatus: () =>
    request<{ versteckt_aktiv: boolean; sichtbar_aktiv: boolean; sichtbar_text: string | null }>('GET', '/export/wm-status'),
