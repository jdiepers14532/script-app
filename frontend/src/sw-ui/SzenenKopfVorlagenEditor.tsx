...
export const SK_CHIPS: SKChipDef[] = [
  ...
  { key: 'innen_aussen',      label: 'I/E lang',       shortLabel: 'I/E',  color: '#FF9500', beschreibung: 'Innen/Außen — langer Wert (int/ext)' },
  { key: 'innen_aussen_kurz', label: 'I/E kurz',      shortLabel: 'I/E¹', color: '#FF9500', beschreibung: 'Innen/Außen — 1 Buchstabe (konfigurierbar unter Allgemein › Szenen-Kürzel)' },
  { key: 'tageszeit_lang',    label: 'Stimmung lang',  shortLabel: 'St',   color: '#5856D6', beschreibung: 'Stimmung/Tageszeit — voller Wert (TAG, NACHT …)' },
  { key: 'tageszeit_kurz',    label: 'Stimmung kurz',  shortLabel: 'St¹',  color: '#5856D6', beschreibung: 'Stimmung/Tageszeit — 1 Buchstabe (konfigurierbar unter Allgemein › Szenen-Kürzel)' },
  { key: 'spielzeit',         label: 'Spielzeit',      shortLabel: 'SpZ',  color: '#34C759', beschreibung: 'Spielzeit der Szene (narrative Uhrzeit der Handlung, z.B. 08:30)' },
