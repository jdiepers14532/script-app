...
export default function App() {
  const { focus, toggle, hoverOpen, setHoverOpen, toolbarOpen, setToolbarOpen } = useFocusMode()
  ...
  return (
    ...
    <AppSettingsContext.Provider value={{ treatmentLabel, sceneKuerzel, figurenLabel, sceneEnvColors }}>
      <ProductionContext.Provider value={productionCtx}>
        <FocusContext.Provider value={{ focus, toggle, hoverOpen, setHoverOpen, toolbarOpen, setToolbarOpen }}>
          <BrowserRouter>
            <Routes>
